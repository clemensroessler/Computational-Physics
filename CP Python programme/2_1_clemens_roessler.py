...
def atan_funktion(x):
    ...
    untersucht werden. Gibt Funktionswert an Stelle x zurück."""
...
def extrapolierte_differenz(fkt, x_0=0, h=10 ** (-6)):
...
def relativer_fehler_ableitung(fkt, ableitung_numerisch,
    ...
    """Die Methode gibt den relativen Fehler der numerischen 
    Ableitungsmethode zurück im Vergleich zur analytischen Methode. Die 
    Methoden werden an der Stelle x_0 und bei Schrittweite h verglichen."""
...
def main():
    ...
    # Parameter
    """data_points gibt die Anzahl an Datenpunkten pro Graph an; x_0_array 
    enthält alle Punkte, an welchen die Ableitungen untersucht werden; 
    h_start und h_end geben Start- und Endpunkt des getesteten Intervalls der 
    Schrittweite an """
    data_points = 1000
